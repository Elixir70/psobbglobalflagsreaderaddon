...
local _FlagsReaderDefaultFlags = {
    ...
    { description="MA4 (GIRASOLE)",                   flagNum=0xF, flagMask=0x00000400, enable=false, hexdisplay=false },
    { description="MA4 (FRIEND RING)",                flagNum=0xF, flagMask=0x00000200, enable=false, hexdisplay=false },
